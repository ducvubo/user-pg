...
//   const [isLoading, setIsLoading] = useState<boolean>(true); // Thêm state để theo dõi trạng thái loading
...
//   return (
//     <div className="flex flex-col  bg-white rounded-lg shadow-lg" style={{ height: 'calc(100vh - 9rem)' }}>
...
//                 <div
//                   className={`max-w-xs p-3 rounded-lg ${msg.userType === userType ? "bg-green-500 text-white" : "bg-gray-100 text-black"
//                     }`}
//                 >
